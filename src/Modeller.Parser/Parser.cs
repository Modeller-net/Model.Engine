...
/// This class is intended to be imported statically ("using static Modeller.DslParser.Parser").
/// </summary>
...
/// <summary>
/// Constructor functions, extension methods and utilities for <see cref="Parser{TToken, T}"/>
/// This class is intended to be imported statically, with the type parameter set to the type of tokens in your input stream ("using static Modeller.DslParser.Parser&lt;char&gt;").
/// </summary>
...
public abstract partial class Parser<TToken, T>
{
    ...
    /// <param name="expected">A list to which the parser can add its expected tokens when it fails.</param>
